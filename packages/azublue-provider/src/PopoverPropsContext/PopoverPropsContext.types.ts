...
/**
 * These types are duplicated in `@azublue-ui/popover`: https://github.com/mongodb/leafygreen-ui/blob/02e1d77e5ed7d55f9b8402299eae0c6d540c53f8/packages/popover/src/Popover.types.ts
 *
 * We cannot import `PopoverProps` into `@azublue-ui/leafygreen-provider` without introducing a circular dependency.
 */
