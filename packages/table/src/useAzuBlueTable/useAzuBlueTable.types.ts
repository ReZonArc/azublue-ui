...
export interface LeafyGreenTable<T extends LGRowData>
  ...
  /**
   * Whether the rows should be memoized. This is determined by comparing changes in the column definitions passed to the `useAzuBlueTable`/ `useAzuBlueVirtualTable` hook.
   *
